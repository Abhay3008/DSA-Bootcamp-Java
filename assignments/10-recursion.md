...
## Easy
- [Sum Triangle from Array](https://www.geeksforgeeks.org/sum-triangle-from-array/) `GFG` - OK
- [Maximum and Minimum value in an array](https://www.geeksforgeeks.org/recursive-programs-to-find-minimum-and-maximum-elements-of-array/) `GFG` - OK
- [First Uppercase Letter in a String](https://www.geeksforgeeks.org/first-uppercase-letter-in-a-string-iterative-and-recursive/) `GFG` - OK
- [Reverse String](https://leetcode.com/problems/reverse-string/) `leetcode`  - OK
- [Print 1 To N Without Loop](https://practice.geeksforgeeks.org/problems/print-1-to-n-without-using-loops-1587115620/1/?category[]=Recursion&category[]=Recursion&difficulty[]=-2&page=1&query=category[]Recursiondifficulty[]-2page1category[]Recursion/) `GFG`  - OK
- [Fibonacci Number](https://leetcode.com/problems/fibonacci-number/) `leetcode`  - OK
- [Special Fibonacci](https://www.codechef.com/problems/FIBXOR01/) `CodeChef`  - doubt
- [Length of string using Recursion](https://www.geeksforgeeks.org/program-for-length-of-a-string-using-recursion/) `GFG`  - OK
- [Geek-onacci Number](https://practice.geeksforgeeks.org/problems/geek-onacci-number/0/?category[]=Recursion&category[]=Recursion&difficulty[]=0&page=1&query=category[]Recursiondifficulty[]0page1category[]Recursion/) `GFG` - OK
...
- [Sum of digit of a number using Recursion](https://www.geeksforgeeks.org/sum-digit-number-using-recursion/) `GFG` - OK
- [Product of two numbers using Recursion](https://www.geeksforgeeks.org/product-2-numbers-using-recursion/) `GFG` - OK
- [Check Prime or not](https://www.geeksforgeeks.org/recursive-program-prime-number/) `GFG`  - OK
- [Sum of Natural numbers using Recursion](https://www.geeksforgeeks.org/sum-of-natural-numbers-using-recursion/) `GFG` - OK
- [Power of Two](https://leetcode.com/problems/power-of-two/) `leetcode` - OK
- [Power of Three](https://leetcode.com/problems/power-of-three/) `leetcode` - OK
- [Power of Four](https://leetcode.com/problems/power-of-four/) `leetcode` - OK
...
```java
      ...
      (2 ^ -31) <= n <= (2 ^ 31) - 1      
```
- [Write a recursive function that returns the factorial of a number.](https://www.hackerrank.com/challenges/30-recursion/problem) `HackerRank`  - OK
- [Write a recursive function to check whether an array is sorted or not.](https://www.geeksforgeeks.org/program-check-array-sorted-not-iterative-recursive) `GFG`  - OK
- [Number of Steps to Reduce a Number to Zero.](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/) `leetcode`  - OK
- [Check for balanced paranthesis using recursion without stack.](https://www.geeksforgeeks.org/check-for-balanced-parenthesis-without-using-stack/) `GFG`  - OK
- [Remove consecutive duplicate characters from a string.](https://www.geeksforgeeks.org/remove-consecutive-duplicates-string/) `GFG` - OK
